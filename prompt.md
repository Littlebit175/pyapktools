...
package:/data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/base.apk=cn.adonet.proxy.server.pro

出力するテキストは
```cn.adonet.proxy.server.pro```
とすること。
...
```adb shell pm path cn.adonet.proxy.server.pro```
に対する応答は、
```
package:/data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/base.apk
package:/data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/split_config.ja.apk
package:/data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/split_config.xxhdpi.apk
```
である。
これは、```cn.adonet.proxy.server.pro```が３つに分割されたapkであることを意味する。

また、apkのファイルパスは```package:```の後方である。
例：```/data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/base.apk```

次に、カレントディレクトリに、```apks```ディレクトリを作成する（無ければ）。

```apks```ディレクトリ上に、```cn.adonet.proxy.server.pro```ディレクトリを作成する。

次に、作成したディレクトリ内に分割apkをすべてダウンロードする。
例：
```
adb pull /data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/base.apk ./apk/cn.adonet.proxy.server.pro
adb pull /data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/split_config.ja.apk ./apk/cn.adonet.proxy.server.pro
adb pull /data/app/~~OAtg8FWk9BLTUzuKaMckhg==/cn.adonet.proxy.server.pro-5Bp1CLmTOl6LI3rB3WyMvg==/split_config.xxhdpi.apk ./apk/cn.adonet.proxy.server.pro
```
